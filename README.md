...
### setGridWidth(gridWidth, propagate)
...
- `doNotpropagate` - Boolean to specify wether existing widgets must be resized. By default widgets are resized. Pass true to avoid it.
